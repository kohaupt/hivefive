...
class HiveDatasetKaggle(Dataset):
    """
    A custom PyTorch Dataset class for bee hive mel spectrogram images from Kaggle. This class is designed to handle mel spectrogram datasets.
    ...
    def __getitem__(self, idx):
        ...
        """
        # Load mel_spec
        mel_spec_path = os.path.join(self.processed_data_path, self.metadata.iloc[idx]["file name"] + ".npy")
